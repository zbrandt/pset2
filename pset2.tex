...
\begin{homeworkProblem}
    ...
    \[
        \begin{split}
            \widehat{\beta_{IV}} = \frac{\beta_1''}{\beta_1'} = \frac{E(Y_i | D_i = 1 - Y_i | D_i = 0)}{E(T_i | D_i = 1 - T_i | D_i = 0)} = \frac{\text{Difference in mean outcomes between groups}}{\text{Difference in fraction treated between groups}}
        \end{split}  
    \]
...
\begin{homeworkProblem}
    ...
    The following first-stage and reduced-form regression specifications were applied to produce the results for (2), (3), and (4):
    
    \[ 
        \begin{split}
            \widehat{educ\_years_i} &= \widehat{\beta_0} + \widehat{\beta_1} \times ln(dist\_us\_km_i)  \: \: \: \text{(2)}
            \\
            \widehat{educ\_years_i} &= \widehat{\beta_0} + \widehat{\beta_1} \times ln(dist\_us\_km_i)  \: \: \: \text{(3)}
            \\
            \widehat{educ\_years_i} &= \widehat{\beta_0} + \widehat{\beta_1} \times ln(dist\_us\_km_i)  \: \: \: \text{(4)}
        \end{split}
    \]
